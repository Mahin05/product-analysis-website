    ...
    return (
        <div>
            <div className='product-details'>
                ...
                <div>
                    <img  className='image-style' src="https://www.hp.com/us-en/shop/app/assets/images/product/2L4H0AV_MB/center_facing.png?_=1638007577867&imwidth=270&imdensity=1" alt="" />
                </div>
            </div>
